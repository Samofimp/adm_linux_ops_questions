...
| ADD | Копирует файлы и директории в контейнер, может распаковывать локальные .tar-файлы и загружать файлы из заданного URL в контейнер. |
...
Инструкция *ADD* имеет более разнообразное применение, в отличие от инструкции *COPY*.

Инструкция *COPY* копирует файлы и директории с хостовой машины внутрь контейнера; инструкция *ADD* копирует файлы и директории с хостовой машины внутрь контейнера, загружает файлы из URL внутрь контейнера и также может распаковывать .tar архивы.
